...
All 43 portable C#/PowerShell suites and their 29 harness/fake-host files are included. The former `Test-MonitorSigning.ps1` is intentionally excluded: it depended on unpublished signing handoff scripts and is not a runtime regression test. This source release does not include signing enrollment, credentials or signing workflows.
